...
public class BoardDaoImpl extends AbstractDao implements BoardDao{
	...
	public BoardDto contentView(String idx) {
		...
		return jdbcTemplate.queryForObject(query, new BeanPropertyRowMapper<BoardDto>(BoardDto.class));
	}
	...
	public ArrayList<BoardDto> list() {
		...
		return (ArrayList<BoardDto>) jdbcTemplate.query(query, new BeanPropertyRowMapper<BoardDto>(BoardDto.class));
	}
